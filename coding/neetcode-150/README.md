...
The NeetCode 150 is a curated list of 150 LeetCode problems grouped into 18 categories. It covers the patterns that show up most often in software and AI Forward Deployed Engineer coding interviews. Work the categories in order; each one builds on the last.
...
1. Read the linked pattern page for the category first.
2. Attempt every problem yourself before looking at any solution. Give each one 20 to 40 minutes.
3. Tick the box when you have solved it once without help, and revisit it a week later.
4. Add your solution under this folder as `category/problem-name.py` with a short note on the approach and complexity.

## Progress

| Category | Solved |
| --- | --- |
| [Arrays & Hashing](#arrays-hashing) | 0 / 9 |
| [Two Pointers](#two-pointers) | 0 / 5 |
| [Sliding Window](#sliding-window) | 0 / 6 |
| [Stack](#stack) | 0 / 6 |
| [Binary Search](#binary-search) | 0 / 7 |
| [Linked List](#linked-list) | 0 / 11 |
| [Trees](#trees) | 0 / 15 |
| [Heap / Priority Queue](#heap-priority-queue) | 0 / 7 |
| [Backtracking](#backtracking) | 0 / 10 |
| [Tries](#tries) | 0 / 3 |
| [Graphs](#graphs) | 0 / 13 |
| [Advanced Graphs](#advanced-graphs) | 0 / 6 |
| [1-D Dynamic Programming](#1-d-dynamic-programming) | 0 / 12 |
| [2-D Dynamic Programming](#2-d-dynamic-programming) | 0 / 11 |
| [Greedy](#greedy) | 0 / 8 |
| [Intervals](#intervals) | 0 / 6 |
| [Math & Geometry](#math-geometry) | 0 / 8 |
| [Bit Manipulation](#bit-manipulation) | 0 / 7 |
| **Total** | **0 / 150** |

## Arrays & Hashing

Related pattern: Hashing and prefix sums. See [Sliding Window](../patterns/01-sliding-window.md) for the substring variants.
...
Related pattern: [Two Pointers](../patterns/02-two-pointers.md)
...
Related pattern: [Sliding Window](../patterns/01-sliding-window.md)
...
Related pattern: Stack and monotonic stack.
...
Related pattern: [Modified Binary Search](../patterns/11-modified-binary-search.md)
...
Related pattern: [Fast and Slow Pointers](../patterns/03-fast-and-slow-pointers.md), [In-place Reversal of a Linked List](../patterns/06-in-place-reversal-of-a-linked-list.md)
...
Related pattern: [Tree Breadth First Search](../patterns/07-tree-breadth-first-search.md), [Tree Depth First Search](../patterns/08-tree-depth-first-search.md)
...
Related pattern: [Top K Elements](../patterns/13-top-k-elements.md), [Two Heaps](../patterns/09-two-heaps.md), [K-way Merge](../patterns/14-k-way-merge.md)
...
Related pattern: [Subsets](../patterns/10-subsets.md)
...
Related pattern: Prefix tree (trie).
...
Related pattern: Graph BFS and DFS, union find, [Topological Sort](../patterns/16-topological-sort-graph.md)
...
Related pattern: Dijkstra, Prim, Kruskal, Bellman-Ford, [Topological Sort](../patterns/16-topological-sort-graph.md)
...
Related pattern: [0/1 Knapsack (Dynamic Programming)](../patterns/15-01-knapsack-dynamic-programming.md)
...
Related pattern: Greedy choice, Kadane.
...
Related pattern: [Merge Intervals](../patterns/04-merge-intervals.md)
...
Related pattern: Matrix traversal and number theory.
...
Related pattern: [Bitwise XOR](../patterns/12-bitwise-xor.md)
...
The NeetCode 150 list is maintained by NeetCode at [neetcode.io](https://neetcode.io). This page reproduces the problem titles, categories, and difficulties for study tracking and links each problem to LeetCode. All problem statements belong to LeetCode.
